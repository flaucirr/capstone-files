...
CREATE TABLE `birth_cert` (
  ...
  `doc_owner_id` int DEFAULT NULL,
  `birth_parents_id` varchar(255) DEFAULT NULL,
  `requestor_info_id` int DEFAULT NULL,
...
CREATE TABLE `birth_requestor` (
  `requestor_info_id` int NOT NULL,
  `l_name` varchar(45) DEFAULT NULL,
  `f_name` varchar(45) DEFAULT NULL,
  `m_name` varchar(45) DEFAULT NULL,
  `suffix_type` enum('Sr.','Jr.','I','II','III','IV','V','VI','VII','VIII','IX','X') DEFAULT NULL,
...
CREATE TABLE `death_cert` (
  `transaction_id` varchar(45) NOT NULL,
  `doc_owner_id` int DEFAULT NULL,
  `region_id` enum('Sr.','Jr.','I','II','III','IV','V','VI','VII','VIII','IX','X') DEFAULT NULL,
  `prov_id` enum('Male','Female') DEFAULT NULL,
...
CREATE TABLE `death_requestor` (
  ...
  `req_lname` varchar(255) DEFAULT NULL,
  `req_fname` varchar(255) DEFAULT NULL,
  `req_mname` varchar(255) DEFAULT NULL,
  `suffix_type` enum('Sr.','Jr.','I','II','III','IV','V','VI','VII','VIII','IX','X') DEFAULT NULL,
  `owner_rel` int DEFAULT NULL,
  `mobile_no` varchar(45) DEFAULT NULL,
  `tel_no` varchar(45) DEFAULT NULL,
  `addr_info_id` int DEFAULT NULL,
...
INSERT INTO `father_info` VALUES (1,'Rufino','P.','Collantes',NULL,NULL);
...
INSERT INTO `mother_info` VALUES (1,'Celestine','P.','Lagaras',NULL,NULL);
...
INSERT INTO `transaction_info` VALUES ('17009060-A708EA32B',20500,7,NULL,NULL,'Nothing'),('17015126-3A70B15A2',90500,NULL,NULL,NULL,NULL),('17016979-751406E50',120000,NULL,NULL,NULL,NULL),('17016979-F642485F9',65000,NULL,NULL,NULL,NULL);
...
INSERT INTO `user_transaction` VALUES ('17009060-A708EA32B','RL1741',1,'Pending','2023-11-25 00:00:00'),('17015126-3A70B15A2','RL1741',1,'Expired','2023-12-02 18:23:55'),('17016979-751406E50','RL1741',1,'Rejected','2023-12-04 21:53:04'),('17016979-F642485F9','RL1741',1,'Expired','2023-12-04 21:51:42');
...
-- Dump completed on 2023-12-05 15:54:28
