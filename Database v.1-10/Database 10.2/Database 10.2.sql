...
INSERT INTO `birth_cert` VALUES ('17019893-300D8D9FB',14,'14A3','14A23');
...
INSERT INTO `birth_doc_owner` VALUES ('17019893-300D8D9FB','EDOGAWA','CONAN','KUDO','Jr.','Male','BASTA HOSPITAL TO','PHILIPPINES','12-08-23');
...
INSERT INTO `birth_info` VALUES ('17019893-300D8D9FB','RL1741','2002-03-25',NULL);
...
INSERT INTO `birth_requestor` VALUES ('17019893-300D8D9FB','LAGARAS','RUFI CARL','P.','X','GUARDIAN','12-32-52-62','41288852','009237182');
...
CREATE TABLE `cedula_other_info` (
  `ced_other_info_id` int NOT NULL,
  `cvl_id` int DEFAULT NULL,
  `czn_id` int DEFAULT NULL,
  `height` int DEFAULT NULL,
  `weight` int DEFAULT NULL,
  `acr_no` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ced_other_info_id`),
  KEY `fk_cedula_other_info_cvl_id` (`cvl_id`),
  KEY `fk_cedula_other_info_czn_id` (`czn_id`),
  CONSTRAINT `fk_cedula_other_info_cvl_id` FOREIGN KEY (`cvl_id`) REFERENCES `cvl_status` (`cvl_id`),
  CONSTRAINT `fk_cedula_other_info_czn_id` FOREIGN KEY (`czn_id`) REFERENCES `czn_status` (`czn_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cedula_tax` (
  ...
  `ced_trans_info_id` int DEFAULT NULL,
  `ced_other_info_id` int DEFAULT NULL,
  PRIMARY KEY (`transaction_id`),
  KEY `fk_tax_ced_trans_info_id` (`ced_trans_info_id`),
  KEY `fk_tax_ced_other_info_id` (`ced_other_info_id`),
  KEY `fk_cedula_tax_sex_id` (`sex_id`),
  KEY `fk_cedula_tax_suffix_id` (`suffix_id`),
  CONSTRAINT `fk_cedula_tax_sex_id` FOREIGN KEY (`sex_id`) REFERENCES `sex_type` (`sex_id`),
  CONSTRAINT `fk_cedula_tax_suffix_id` FOREIGN KEY (`suffix_id`) REFERENCES `suffix_type` (`suffix_id`),
  CONSTRAINT `fk_tax_ced_other_info_id` FOREIGN KEY (`ced_other_info_id`) REFERENCES `cedula_other_info` (`ced_other_info_id`),
  CONSTRAINT `fk_tax_ced_trans_info_id` FOREIGN KEY (`ced_trans_info_id`) REFERENCES `cedula_transaction_info` (`ced_trans_info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cedula_transaction_info` (
  `ced_trans_info_id` int NOT NULL,
  `ced_acc_no` varchar(255) DEFAULT NULL,
  `emp_type` enum('Full-time','Part-time','Contract','Freelance','Self-employed') DEFAULT NULL,
  `profession` varchar(255) DEFAULT NULL,
  `res_tax_due` varchar(255) DEFAULT NULL,
  `income_real_property` int DEFAULT NULL,
  `bus_preceding_year` int DEFAULT NULL,
  `prof_pursuit_occup` int DEFAULT NULL,
  PRIMARY KEY (`ced_trans_info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `death_cert` VALUES ('17017840-15A592299',14,'14A4','14A29','2023-12-25'),('17017885-32527180D',14,'14A3','14A23','2023-12-05'),('17018022-AE3FFF129',NULL,NULL,NULL,NULL),('17018044-CB8CE47AD',NULL,NULL,NULL,NULL),('17018060-6C8CE8264',NULL,NULL,NULL,NULL);
...
INSERT INTO `death_doc_owner` VALUES ('17017840-15A592299','BASA','ATANACIO','GO','III','Male'),('17017885-32527180D','ASD','ASD','ASD','Jr.','Female'),('17018022-AE3FFF129','1','1','A','III','Female'),('17018044-CB8CE47AD',NULL,NULL,NULL,NULL,NULL),('17018060-6C8CE8264','A','A','A','Sr.','Male');
...
INSERT INTO `death_requestor` VALUES ('17017840-15A592299','LAGARAS','RUFI CARL','PRUDENCIADO','II','BROTHER','09996938241','1234567890'),('17017885-32527180D','ASD','ASDASD','ASDASD','Jr.','ASD','ASD','ASD'),('17018022-AE3FFF129',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('17018044-CB8CE47AD','ASD','ASD','ASD','Sr.','ASD','ASD','ASD'),('17018060-6C8CE8264',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `father_info` VALUES ('1','Rufino','P.','Collantes',NULL,NULL),('17019893-300D8D9FB','YUSAKU','M','KUDO','Sr.',NULL);
...
INSERT INTO `mother_info` VALUES ('1','Celestine','P.','Lagaras',NULL,NULL),('17019893-300D8D9FB','YUKIKO','M','SHINICHI','II',NULL);
...
INSERT INTO `transaction_info` VALUES ('17009060-A708EA32B',20500,7,NULL,NULL,NULL),('17015126-3A70B15A2',90500,NULL,NULL,NULL,NULL),('17016979-751406E50',120000,NULL,NULL,NULL,NULL),('17016979-F642485F9',65000,NULL,NULL,NULL,NULL),('17017840-15A592299',250,2,'Front and Back',10,3),('17017885-32527180D',0,NULL,NULL,NULL,NULL),('17018022-AE3FFF129',0,NULL,NULL,NULL,NULL),('17018044-CB8CE47AD',0,NULL,NULL,NULL,NULL),('17018060-6C8CE8264',0,NULL,NULL,NULL,NULL),('17019893-300D8D9FB',550,5,'Front and Back',7,3);
...
-- Dump completed on 2023-12-08  6:53:05
