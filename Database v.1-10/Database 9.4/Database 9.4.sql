...
CREATE TABLE `cedula_tax` (
  ...
  `acr_no` int DEFAULT NULL,
  PRIMARY KEY (`transaction_id`),
  KEY `fk_cedula_tax_addr_info` (`addr_info_id`),
  KEY `fk_cedula_tax_user_personal` (`user_id`),
  CONSTRAINT `fk_cedula_tax_addr_info` FOREIGN KEY (`addr_info_id`) REFERENCES `address_info` (`addr_info_id`),
  CONSTRAINT `fk_cedula_tax_user_personal` FOREIGN KEY (`user_id`) REFERENCES `user_personal` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-12-03 23:55:07
