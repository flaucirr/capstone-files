...
--
-- Table structure for table `death_date`
--

DROP TABLE IF EXISTS `death_date`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `death_date` (
  `death_date_id` int NOT NULL,
  `year_id` int NOT NULL,
  `month_id` int NOT NULL,
  `death_day` int NOT NULL,
  PRIMARY KEY (`death_date_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `death_date`
--

LOCK TABLES `death_date` WRITE;
/*!40000 ALTER TABLE `death_date` DISABLE KEYS */;
/*!40000 ALTER TABLE `death_date` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `month` (
  `month_id` int NOT NULL,
  `month_period` varchar(45) DEFAULT NULL,
...
CREATE TABLE `user_personal` (
  ...
  `czn_id` int DEFAULT NULL,
  PRIMARY KEY (`user_id`),
  KEY `idx_b_place` (`birth_id`),
  KEY `idx_sex_id` (`sex_id`),
  KEY `idx_cvl_id` (`cvl_id`),
  CONSTRAINT `fk_user_personal_b_place` FOREIGN KEY (`birth_id`) REFERENCES `metromanila_cities` (`city_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO `user_personal` VALUES ('MM3284','Mhandee Louise','Bautista','Matis',NULL,2,2,17,NULL,NULL),('RL1741','Rufi Carlolita','Prudenciados','Lagaras',NULL,NULL,1,9,NULL,NULL);
...
CREATE TABLE `user_transaction` (
  ...
  `cedula_id` int DEFAULT NULL,
  `birth_cert_id` int DEFAULT NULL,
  `marriage_id` int DEFAULT NULL,
  `death_cert_id` int DEFAULT NULL,
...
-- Dump completed on 2023-11-06 22:37:45
