...
CREATE TABLE `cedula_tax` (
  ...
  KEY `fk_cedula_tax_addr_info_id` (`addr_info_id`),
  KEY `fk_cedula_tax_sex_id` (`sex_id`),
  KEY `fk_cedula_tax_suffix_id` (`suffix_id`),
  CONSTRAINT `fk_cedula_tax_addr_info_id` FOREIGN KEY (`addr_info_id`) REFERENCES `address_info` (`addr_info_id`),
...
INSERT INTO `rptax_payment` VALUES ('17009060-A708EA32B','RUFI LAGARAS','0343875795934345','0249796345234234',2023,'3rd Quarter'),('17015126-3A70B15A2','CARAMEL','FG3453453454','76879232435435DFGFD',2013,'3rd Quarter');
...
INSERT INTO `transaction_info` VALUES ('17009060-A708EA32B',20500,7,NULL,NULL,'Nothing'),('17015126-3A70B15A2',90500,NULL,NULL,NULL,NULL);
...
INSERT INTO `user_transaction` VALUES ('17009060-A708EA32B','RL1741',1,'Pending','2023-11-25 00:00:00'),('17015126-3A70B15A2','RL1741',2,'Paid','2023-12-02 18:23:55');
...
-- Dump completed on 2023-12-04 20:33:52
