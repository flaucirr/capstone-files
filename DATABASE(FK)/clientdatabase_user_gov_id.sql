...
CREATE TABLE `user_gov_id` (
  ...
  `user_tin_id` varchar(255) NOT NULL,
  `user_pgb_id` int NOT NULL,
  `user_philh_id` int NOT NULL,
  `user_sss_id` int NOT NULL,
  `user_gsis_id` int NOT NULL,
  `user_natl_id` int NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2023-10-18 23:16:14
