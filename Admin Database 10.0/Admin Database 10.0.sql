...
INSERT INTO `admin_auth` VALUES ('bpadmin','$2b$10$jKUZFpk.XtuWjD8qicoelenjCmOUByl7csw7KK42.kdCTWgoVj3qa','Jeremiah Alvarez','business_admin'),('chiefadmin','$2b$10$GCwoHl7.U6Kk4/2PZ6ptlOVIPUmTMUzI8cSeFRTkOET7JYPRHodNq','Miles John Luna','chief_admin'),('ctcadmin','$2b$10$r1YuJju5hfE8zaPQVf2J6.YqJssckKMnvOMtT6xN7XfhXdqGAZD0S','Jule Michael Dones','cedula_admin'),('lcradmin','$2b$10$xSfFVEOjW3e.EsVRkcPqV.3SJ6cDD662WwxnFKURKbxldfqTccTg.','Paolo Maghirang','lcr_admin'),('lcradmin1','$2b$10$rrztqomeSj1FSZsfmpMWh.4Xph/Ks5Z7fUdgTnQOvWWE3pBLSCxGy','Mhandee Matis','lcr_admin'),('registryadmin','g{|k|_[9G_C2:U','Atanacio Basa','registry_admin'),('rptaxadmin','$2b$10$X0xxMnafkziwWgmyyski0ukCHtpd7hOHdtvfF5RiHuwlgxVoOOgKO','Rufi Carl Lagaras','rptax_admin'),('rptaxadmin1','$2b$10$/WRieKeKvj0rmBPtq.ft.uahrqkCQpUUdIRK3xLz1wA58PcYbMqQ.','Danilo Torres ','rptax_admin');
...
INSERT INTO `admin_profile` VALUES ('registryadmin',NULL,'Atanacio Basa','registry_admin'),('rptaxadmin1',NULL,'Danilo Torres','rptax_admin'),('bpadmin','BP.jpg','Jeremiah Alvarez','business_admin'),('ctcadmin',NULL,'Jule Michael Dones','cedula_admin'),('lcradmin1',NULL,'Mhandee Matis','lcr_admin'),('chiefadmin',NULL,'Miles John Luna','chief_admin'),('lcradmin',NULL,'Paolo Maghirang','lcr_admin'),('rptaxadmin',NULL,'Rufi Carl Lagaras','rptax_admin');
...
-- Dump completed on 2024-05-28  1:55:21
