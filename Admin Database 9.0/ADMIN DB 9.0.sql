...
INSERT INTO `admin_auth` VALUES ('bpadmin','{)+zrJ5h;|z?2h','Jeremiah Alvarez','business_admin'),('chiefadmin','H&5z^)I#V3oDDN','Miles John Luna','chief_admin'),('ctcadmin',')fk%dBZ$d1)zyr','Jule Michael Dones','cedula_admin'),('lcradmin','y@0jn?itT|C{qN','Paolo Maghirang','lcr_admin'),('lcradmin1','ZcrbDP%9BE)PNt','Mhandee Matis','lcr_admin'),('registryadmin','g{|k|_[9G_C2:U','Atanacio Basa','registry_admin'),('rptaxadmin','(X@H_VkZAT)gN.','Rufi Carl Lagaras','rptax_admin'),('rptaxadmin1','Ffbm59W1k|C|]t','Danilo Torres ','rptax_admin');
...
-- Dump completed on 2024-05-27  0:21:57
