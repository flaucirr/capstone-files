...
CREATE TABLE `user_contact` (
  ...
  PRIMARY KEY (`user_id`),
  KEY `fk_user_contact_user_municipal_idx` (`user_city`),
  CONSTRAINT `fk_user_contact_user_city` FOREIGN KEY (`user_city`) REFERENCES `metromanila_cities` (`city_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_personal` VALUES ('MM3284','Mhandee Louise','Bautista','Matis',NULL,2,2,NULL,17,NULL,NULL),('RL1741','Rufi Carl','Prudenciado','Lagaras',NULL,2,1,NULL,9,NULL,NULL);
...
-- Dump completed on 2023-10-23 23:24:46
